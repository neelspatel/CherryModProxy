def get(arg):	
	...
	addBook = '<li class="dropdown-submenu pull-left" style = "width:100px;"><a tabindex="-1" href="#">' + 'The Coop'  + '   <i class="icon-plus-sign"></i></a><ul class="dropdown-menu" style = "width:100px; padding: 0px 20px 10px 20px; left:-150% !important;"><h2 style = "text-align: center">The Coop</h2><img src = "http://www.graphicsfuel.com/wp-content/uploads/2012/07/red-book.png" style = "width:100px; margin:auto; display: block;"></img><p> Recieve $5 off books if you buy in the next 45 minutes! </p></ul></li>'
	addPrinter = '<li class="dropdown-submenu pull-left" style = "width:100px;"><a tabindex="-1" href="#">' + 'Staples'  + '   <i class="icon-plus-sign"></i></a><ul class="dropdown-menu" style = "width:100px; padding: 0px 20px 10px 20px; left:-150% !important;"><h2 style = "text-align: center">Staples</h2><img src = "http://icons.iconarchive.com/icons/artua/dragon-soft/512/Printer-icon.png" style = "width:100px; margin:auto; display: block;"></img><p> Recieve free ink for a year if you buy in the next 45 minutes! </p></ul></li>'
	addBookFunction = "function addBook() {jQuery('.outerDropdown').append('" + addBook+ "'); return true;}; jQuery('.addBook').click(addBook);"
