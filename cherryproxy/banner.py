def get(arg):
	...
	output = '<div class="navbar navbar-fixed-top navbar-inverse" style = "margin-left: 0px; margin-right: 0px; width: 100%;"><div class="navbar-inner"><a class="brand" href="#">Butucu</a><ul class = "nav pull-right"><li class="dropdown" ><a href="#" class="dropdown-toggle" data-toggle="dropdown" onclick = ""><i class="icon-tags icon-white"></i> Deals <span class="badge badge-important" id = "couponCount"></span> <b class="caret"></b></a><ul class="dropdown-menu  outerDropdown" style = "min-width:50px !important;"></ul></li></ul>      </div></div>'
	return output
